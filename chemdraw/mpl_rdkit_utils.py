# Source: https://raw.githubusercontent.com/itakigawa/mpl_rdkit_utils/main/mpl_rdkit_utils.py
## The repo has also a very good example page
## https://github.com/itakigawa/mpl_rdkit_utils/blob/main/example.ipynb
# quick fix
...
def draw_mol_mpl(
    ...
    options.wedgeDashedBonds = wedge_bonds
...
def get_smiles(
    ...
    """
    # Source: https://github.com/itakigawa/mpl_rdkit_utils/blob/main/example.ipynb
    :param queries:
    :return:
    """
    for q in queries:
        try:
            c = _pcp_get_compound(q)
        except IndexError:
            raise
        yield c.isomeric_smiles


def get_mol_from_strings(
        queries: List[str]
):
    return [Chem.MolFromSmiles(smi) for smi in get_smiles(queries)]
